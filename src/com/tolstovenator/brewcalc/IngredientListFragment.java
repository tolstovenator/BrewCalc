...
/**
 * A list fragment representing a list of Ingredients. This fragment also
 * supports tablet devices by allowing list items to be given an 'activated'
 * state upon selection. This helps indicate which item is currently being
 * viewed in a {@link IngredientDetailFragment}.
 * <p>
...
public class IngredientListFragment extends ListFragment {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		String[] ingredients = new String[IngredientType.values().length];
	...
	public void onListItemClick(ListView listView, View view, int position,
		...
		mCallbacks.onItemSelected(IngredientType.values()[position]);
	}
